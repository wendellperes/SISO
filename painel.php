...
<html lang="pt"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <title>Sorrident - Plano de Saúde   wenddel</title>
    ...
    <body class="bg-white" style="background-color: #ccc;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item <?php if ($_GET['pagina']=='financeiro') {echo 'active';} ?>">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="Calendario/CalendarioView.php?"><img src='glyph/svg/si-glyph-abacus.svg' style="width: 25px; "> Agenda</a>
                    </li>
                    <li class="nav-item">
        ...
        <!--  <img class="mr-3" src="Interface/img/logo1.png" alt="" width="60" height="60"> -->
                <div class="lh-100">
                    <h6 class="mb-0 text-white lh-100">@Sorridentwendell</h6>
