            ...
            if ($listaOrcamentos != null) {
                foreach ($listaOrcamentos as $user4) {
                    ...
                    <table style="border: 1px solid #000; margin-left: 10%; width: 80%;" class="table table-bordered">
                        <tr>
                            <td style="text-align: center;" ><img src="../Interface/img/icon.png" style="width: 50%; "></td>
                            <td colspan="2" style="text-align: center; font-size: 24pt;">Sorrident - Clínica Odontológica Especializada</td>
                        ...
                        if ($listaProcedimentos != null) {
                            foreach ($listaProcedimentos as $user4) {
                                ...
                                <tr>
                                    <th style=""><small style="color:#0062cc; text-align: left;">Valor</small></th>
